...
function AdminSignup() {
  ...
  const handleSignup = async () => {
    try {
      const response = await axios.post('http://localhost:3001/admin-signup', { name, email, password, adminKey });
    ...
    <div className="signup-container">
      <div className="signup-card">
        ...
        <input
          ...
          className="signup-input"
        />
        <button onClick={handleSignup} className="signup-button">Sign Up as Admin</button>
